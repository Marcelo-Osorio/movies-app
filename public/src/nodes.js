...
const btnLanguage=document.querySelector(".select-lang");
const containerLanguage=document.querySelector(".select-language");
const bannerTitle = document.querySelector('.banner-tl'); 
const bannerText = document.querySelector('.banner-tl>p'); 